...
class QLearningAgent(ReinforcementAgent):
    ...
    def __init__(self, **args):
        ...
        # I left out the parentheses after util.Counter at first and
        # got a million errors saying it expected a float instead of a counter
        # Always the smallest mistakes.
    ...
    def update(self, state, action, nextState, reward: float):
        ...
        newValue = (1 - self.alpha) * self.getQValue(state, action) + self.alpha * (reward + self.discount *
